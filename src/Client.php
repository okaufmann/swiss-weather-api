...
class Client
{
    ...
    public function getPrecipitation($stationId)
    {
        $this->getParametersAndVersions();
        $parameterName = self::PARAMETER_PRECIPITATION;
        $version = $this->getParameterVersion($parameterName);
        $station = $this->getStation($version, $parameterName, $stationId);

        return $station;
    }

    public function getTemperature($stationId)
    {
        $this->getParametersAndVersions();
    ...
    public function getFoehn($stationId)
    {
        $this->getParametersAndVersions();
    ...
    public function getHumidity($stationId)
    {
        $this->getParametersAndVersions();
    ...
    public function getParameterVersion($parameeterName)
    {
    ...
    public function getStations($parameterName, $version)
    {
        $lang = 'de';
    ...
    private function getStation($version, $parameterName, $stationId)
    {
        $lang = 'de';
